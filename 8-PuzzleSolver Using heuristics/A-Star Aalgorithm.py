...
def main():
    ...
    print(f"Start State: \n{start}{start.g_n} {start.h_n}")
    print(f"Goal State: \n{goal}{start.g_n} {start.h_n}")
    solver = PuzzleSolver(start,goal)

    # Measure time for A_algorithm_hamming
#     hamming_time = timeit.timeit(lambda: solver.A_algorithm_hamming(), number=1)
#     print(f"\nExecution time for A* algorithm with Hamming heuristic: {hamming_time:.6f} seconds")

    # Measure time for A_algorithm_manhattan
#     manhattan_time = timeit.timeit(lambda: solver.A_algorithm_manhattan(), number=1)
#     print(f"Execution time for A* algorithm with Manhattan heuristic: {manhattan_time:.6f} seconds")
